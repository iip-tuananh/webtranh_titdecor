                                ...
                                <form id="add-to-cart-form" class="form-inline">
                                    ...
                                    <div class="form-product">
                                            ...
                                            <div class="flex-quantity">
                                                ...
                                                <div class="btn-mua button_actions clearfix">
                                                    <div class="group-button">
                                                        <button type="submit"
                                                            class="btn btn_base normal_button btn_add_cart add_to_cart btn-cart" ng-click="addToCartFromProductDetail()">
                                                            Thêm vào giỏ hàng
                                                        </button>
                                                        <button type="button"
                                                            class="btn btn-lg btn-gray btn_buy btn-buyNow" ng-click="addToCartCheckoutFromProductDetail()">Mua
                                                            ngay</button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-hotline">
                                            <img class="img-full"
                                                src="/site/images/hotline-product.png?1743048451127"
                                                alt="" />
                                            Hotline & Zalo hỗ trợ 24/7:
                                            <a href="tel:{{str_replace(' ', '', $config->hotline)}}" title="{{$config->hotline}}">{{$config->hotline}}</a>
